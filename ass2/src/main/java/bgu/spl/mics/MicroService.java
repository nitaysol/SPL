...
public abstract class MicroService implements Runnable {
    private CountDownLatch TimeServiceWait;
     ...
     * @param TimeServiceWait optional(allowed to add in the assignment forum)
     */
    public MicroService(String name, CountDownLatch TimeServiceWait)
    {
        this.name=name;
        this.TimeServiceWait=TimeServiceWait;
    ...
    public final void run() {
        ...
        initialize();
        if(TimeServiceWait!=null)
            this.TimeServiceWait.countDown();
        while (!terminated) {
            try {
                Message m = mBus.awaitMessage(this);
                if(m!=null){
